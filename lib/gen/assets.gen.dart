...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/podycast.png
  AssetGenImage get podycast =>
      const AssetGenImage('assets/images/podycast.png');

  /// File path: assets/images/postertest.png
  AssetGenImage get postertest =>
      const AssetGenImage('assets/images/postertest.png');

  /// File path: assets/images/radiocodeyad.png
  AssetGenImage get radiocodeyad =>
      const AssetGenImage('assets/images/radiocodeyad.png');
