...
List<HashtgTagModel> tagList 

= [
  HashtgTagModel(title: "جاوا"),
  HashtgTagModel(title: "کاتلین"),
  HashtgTagModel(title: "وب"),
  HashtgTagModel(title: "هوش مصنوعی"),
  HashtgTagModel(title: "iot"),
  HashtgTagModel(title: "دارت"),
];



List<HashtgTagModel> selectedTags = []; 
...
List<PodCastModel> podCastList = [
  PodCastModel(id: 1, imageUrl: Assets.images.ramzon.path, title: "رمزون"),
  PodCastModel(
      id: 2, imageUrl: Assets.images.radiocodeyad.path, title: "رادیو کدیاد"),
  PodCastModel(
      id: 3, imageUrl: Assets.images.tecnocast.path, title: "تکنو کست"),
  PodCastModel(id: 2, imageUrl: Assets.images.podycast.path, title: "پادی کست"),
];
